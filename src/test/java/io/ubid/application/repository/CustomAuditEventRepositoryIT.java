package io.ubid.application.repository;

import io.ubid.application.UbidApp;
import io.ubid.application.config.Constants;
import io.ubid.application.config.audit.AuditEventConverter;
import io.ubid.application.domain.PersistentAuditEvent;
...
import static io.ubid.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
